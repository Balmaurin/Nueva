  ...
  return (
    <div className="h-screen bg-gray-900 text-white overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full grid grid-cols-12 grid-rows-6 gap-1 p-2">
          {/* Fila 1 - Chat y Métricas Principales */}
          <div className="col-span-6 row-span-3 bg-gray-800 rounded-lg p-3 flex flex-col overflow-hidden">
          ...
          <div className="col-span-3 row-span-2 bg-gray-800 rounded-lg p-3 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-2">
              <h3 className="text-sm font-semibold text-green-400 mb-1">📊 Sistema</h3>
            </div>
            <div className="flex-1 text-xs space-y-2">
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-gray-700 rounded p-2">
                  <p className="text-gray-400">CPU</p>
                  <p className="text-lg font-bold text-green-400">{systemMetrics.cpu}%</p>
                </div>
                <div className="bg-gray-700 rounded p-2">
                  <p className="text-gray-400">Memoria</p>
                  <p className="text-lg font-bold text-blue-400">{systemMetrics.memory}%</p>
                </div>
                <div className="bg-gray-700 rounded p-2">
                  <p className="text-gray-400">Disco</p>
                  <p className="text-lg font-bold text-yellow-400">{systemMetrics.disk}%</p>
                </div>
                <div className="bg-gray-700 rounded p-2">
                  <p className="text-gray-400">Conexiones</p>
                  <p className="text-lg font-bold text-purple-400">{systemMetrics.connections}</p>
                </div>
              </div>
              <div className="mt-2">
                <p className="text-gray-400 mb-1">Notificaciones</p>
                {notifications.map(note => (
                  <div key={note.id} className="bg-gray-700 rounded p-2 mb-1">
          ...
          {/* Fila 3 - Ramas IA y Entrenamiento */}
          <div className="col-span-4 row-span-2 bg-gray-800 rounded-lg p-3 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-2">
          ...
          {/* Fila 4 - Herramientas Avanzadas */}
          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-red-400">🧠 Memoria</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">RAG activo</p>
              <p className="text-xs">12.5K vectores</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-blue-400">🔍 Embeddings</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">768 dim</p>
              <p className="text-xs">FAISS index</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-green-400">📊 Evaluación</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">Coherencia</p>
              <p className="text-xs">94.2%</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-yellow-400">🎯 Refuerzo</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">PPO activo</p>
              <p className="text-xs">Época 147</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-purple-400">⚡ Benchmarks</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">MMLU</p>
              <p className="text-xs">76.4%</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-orange-400">🌍 i18n</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">8 idiomas</p>
              <p className="text-xs">Auto-trad</p>
            </div>
          </div>

          {/* Fila 5 - Sistema y Monitoreo */}
          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-cyan-400">📊 Monitoreo</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">5 servicios</p>
              <p className="text-xs text-green-400">Todos OK</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-pink-400">📊 Visualización</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">Plotly</p>
              <p className="text-xs">12 gráficos</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-indigo-400">🔗 Integraciones</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">8 APIs</p>
              <p className="text-xs">Webhooks</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-teal-400">🔌 Plugins</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">12 activos</p>
              <p className="text-xs">Auto-carga</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-gray-400">💾 Backup</h4>
            </div>
            <div className="flex-1 text-xs">
              <p className="text-gray-400">Auto</p>
              <p className="text-xs">Último: 2h</p>
            </div>
          </div>

          <div className="col-span-2 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-red-400">🔒 Auditoría</h4>
            </div>
            <div className="flex-1 text-xs">
          ...
          {/* Fila 6 - Configuración y Sistema Completo */}
          <div className="col-span-4 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-green-400">🚀 Despliegue</h4>
            </div>
            <div className="flex-1 text-xs">
          ...
          <div className="col-span-4 row-span-1 bg-gray-800 rounded-lg p-2 flex flex-col overflow-hidden">
            <div className="flex-shrink-0 mb-1">
              <h4 className="text-xs font-semibold text-blue-400">📝 Logs</h4>
            </div>
            <div className="flex-1 text-xs">
              <div className="bg-gray-900 rounded p-1 font-mono text-xs">
                [INFO] Chat processed<br/>
                [INFO] Token minted<br/>
                [WARN] High CPU usage
              </div>
            </div>
          </div>
